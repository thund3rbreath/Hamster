...
| **AUTO_UPGRADE** | AUTO upgrade cards if possible (default: True)                                                                      |
| **UPGRADE_COEFFICIENT** | Upgrade if profit is larger than this value (default: 200)                                                                      |
| **AUTO_PLAYGROUND** | Auto play playground game (default: True)                                                                      |
...
```shell
~/Hamster-kombat >>> python3 main.py --action (1/2)
# Or
~/Hamster-kombat >>> python3 main.py -a (1/2)
...
You can also use arguments for quick start, for example:
```termux
~/Hamster-kombat > python main.py --action (1/2)
# Or
~/Hamster-kombat > python main.py -a (1/2)
